...
mv /afs/cern.ch/user/m/mshi/GHHAA2MUMUTAUTAU_GEN/CMSSW_7_1_11_patch2/src/Generation/DIRNAME/SCRIPTNAME_JOBNUM.* . 
cmsRun SCRIPTNAME_JOBNUM.py
cmsStage -f NMSSM_h300_a9_ggH_JOBNUM.root /store/user/mshi/DIRNAME
rm SCRIPTNAME_JOBNUM.*  NMSSM_h300_a9_ggH_JOBNUM.root*
